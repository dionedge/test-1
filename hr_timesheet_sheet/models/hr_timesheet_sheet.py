        ...
        for sheet in self:
            ...
            if new_user_id:
                ...
                if any(self.env.cr.fetchall()):
                    raise ValidationError(_('You cannot have 2 timesheets for the same time period.\nPlease use the menu \'My Current Timesheet\' to check your all active timesheets.'))
